...
function nuevaPublicacion() {
  ...
  // NO limpiamos encargada
  // para que siga seleccionada


  // Ocultar publicación anterior
  ...
  $("#vistaGenerador")?.scrollIntoView({
    behavior: "smooth",
    block: "start"
  });


  // Cursor listo para siguiente producto
  nombre?.focus();
}